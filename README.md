...
The repor can be checked in the follwoing link of our jupyter notebook: https://jupyter.org/try-jupyter/lab?path=notebooks%2Fbell_tannous_abdelkarim_bicudobregion.ipynb
